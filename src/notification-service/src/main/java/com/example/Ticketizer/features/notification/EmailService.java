...
public class EmailService {
    ...
    public void sendTicketConfrimationEmail(TicketNotificationEvent event) {
        try {
            ...
            String bannerImageUrl = "https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?auto=format&fit=crop&w=600&q=80";
        ...
        java.util.concurrent.CompletableFuture.runAsync(() -> {
            try {
                ...
                String htmlBody = String.format(
                    ...
                    "        <a href='https://ticketizer.com/help' class='btn' style='color: #ffffff; text-decoration: none;'>Help</a>" +
                    "      </div>" +
                    "    </div>" +
                    "    " +
                    "    <div class='footer'>" +
                    "      <h4 class='footer-title'>Ticketizer</h4>" +
                    "      <p style='margin: 0; font-size: 11px; color: #94A3B8;'>© 2026 Ticketizer Inc. All rights reserved.</p>" +
                    "    </div>" +
                    "  </div>" +
                    "</body>" +
                    "</html>",
