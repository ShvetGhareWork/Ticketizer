...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        try {
            ...
            log.warn("Could not truncate bookings table (it might not exist yet): {}", ex.getMessage());
        }
        ...
        log.info("DataSeeder: Pipeline initialization complete.");
    }
    ...
    private void seedShowSeats(Show show, String[] rows, int seatsPerRow) {
        ...
        log.info("Successfully staged {} relational seat vectors for Show ID: {}", redisSeatIds.size(), show.getId());
    }
}
