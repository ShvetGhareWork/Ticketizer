package com.example.Ticketizer.features.inventory.config;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/v1/reservations/show/**").permitAll()
                .requestMatchers(HttpMethod.PUT, "/api/v1/seats/status").permitAll() // Internal calls
