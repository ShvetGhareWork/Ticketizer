  ...
  useEffect(() => {
    ...
    if (!isTicketmasterId) {
      ...
      setEventData({
        ...
        url: "#",
        description: "Witness history in the making as the two titans of the IPL, Mumbai Indians and Chennai Super Kings, face off in the grand finale of the 2026 season. This isn't just a game; it's a battle for supremacy in the cathedral of Indian cricket. Expect high-octane action, strategic masterclasses, and an atmosphere that defies description.",
  ...
  if (!eventData) {
    return (
      <div
        className={`min-h-screen bg-[#F8F9FA] text-gray-900 flex flex-col font-sans items-center justify-center ${jakarta.className}`}
      >
        <span className="text-lg font-extrabold text-gray-700 mb-4 uppercase">
          Event Not Found
        </span>
        <Link
          href="/events"
          className="bg-blue-600 text-white px-6 py-2.5 rounded font-bold hover:bg-blue-700 transition-colors shadow-sm text-sm"
        >
          Return to Events
        </Link>
      </div>
  ...
  return (
    ...
    >
      ...
      <section className="relative w-full h-[320px] sm:h-[400px] lg:h-[480px] bg-blue-900 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-full px-4 sm:px-6 lg:px-12 pb-8 sm:pb-12 z-10 flex flex-col">
          <span className="self-start bg-[#0052CC] text-white text-[10px] sm:text-xs font-bold tracking-widest px-3 py-1.5 rounded-sm uppercase mb-4 shadow-sm">
            {eventData.category}
          </span>
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 tracking-tight mb-3">
            {eventData.title}
          </h1>
          <div className="flex flex-wrap items-center gap-3 sm:gap-4">
            ...
            <span className="bg-white/80 backdrop-blur-sm text-gray-700 text-xs sm:text-sm font-semibold px-3 py-1.5 rounded-full shadow-sm">
      ...
      <main className="flex-1 max-w-[1440px] mx-auto w-full px-4 sm:px-6 lg:px-12 py-8 lg:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-7 xl:col-span-8 flex flex-col">
            ...
            <div className="flex gap-6 sm:gap-8 border-b border-gray-200 mb-8 overflow-x-auto no-scrollbar">
              {["ABOUT", "LINEUP", "VENUE", "REVIEWS"].map((tab) => (
                <button
                  ...
                  className={`pb-3 text-xs sm:text-sm font-bold tracking-widest uppercase whitespace-nowrap transition-colors ${
                    activeTab === tab
              ...
              <div className="space-y-8 animate-in fade-in duration-300">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-[#F0F4F8] border border-gray-200 rounded-xl p-5 sm:p-6">
                    ...
                    <h3 className="text-xs font-bold tracking-widest text-gray-900 uppercase mb-2">
                      Official Seating
                    </h3>
                    <p className="text-xs text-gray-600 font-medium leading-relaxed">
                      Secured tickets directly from Ticketmaster inventory with instant allocation.
                    </p>
                  </div>
                  <div className="bg-[#F0F4F8] border border-gray-200 rounded-xl p-5 sm:p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {eventData.tags.map((tag) => (
                    <span
                      key={tag}
                      className="bg-[#EBECEF] text-gray-700 text-[10px] sm:text-xs font-bold tracking-widest px-3 py-1.5 rounded-full uppercase"
                    >
                      {tag}
                    </span>
                  ))}
            ...
            {activeTab !== "ABOUT" && (
              <div className="h-48 flex items-center justify-center bg-[#F0F4F8] border border-gray-200 rounded-xl animate-in fade-in duration-300">
          ...
          <div className="lg:col-span-5 xl:col-span-4 relative mt-4 lg:mt-0">
            <div className="lg:sticky lg:top-24 space-y-4">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-5 sm:p-6 shadow-sm">
                <h3 className="text-[11px] font-bold tracking-widest text-gray-500 uppercase flex items-center gap-2 mb-5">
                    ...
                    >
                      <div className="flex justify-between items-start mb-4">
                        <div>
                          ...
                          <p className="text-[10px] sm:text-xs font-bold tracking-widest text-gray-500 uppercase mt-1">
                            {show.time} • {show.location}
                          </p>
                        </div>
                        <span
                          className={`${show.scarcityColor} text-[8px] sm:text-[9px] font-extrabold tracking-widest px-2 py-1 rounded-sm uppercase`}
                        >
                          {show.scarcityLabel}
                        </span>
                      </div>
                      ...
                      <div className="flex justify-between items-center border-t border-gray-100/50 pt-3">
                        <div className="flex items-baseline gap-1">
                          <span className="text-lg sm:text-xl font-bold font-mono text-blue-700">
                            {show.price}
                          </span>
              ...
              {/* Warning Banner */}
              <div className="bg-[#FFE5E5] border border-[#FFCCCC] text-[#D32F2F] rounded-lg p-4 flex items-start sm:items-center gap-3">
                <AlertTriangle
                  size={18}
                  className="flex-shrink-0 mt-0.5 sm:mt-0"
                />
                <p className="text-[10px] sm:text-xs font-bold tracking-widest uppercase leading-tight">
      ...
      <footer className="bg-[#F0F4F8] border-t border-gray-200 mt-auto">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 py-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-center md:text-left">
            <h2 className="font-extrabold text-xl text-blue-900 mb-1 tracking-tight">
              Ticketizer
            </h2>
            <p className="text-xs text-gray-500 font-medium">
              © 2024 Ticketizer. All seats are final.
            </p>
          </div>

          <div className="flex gap-6 text-[11px] font-bold tracking-widest text-gray-600 uppercase">
